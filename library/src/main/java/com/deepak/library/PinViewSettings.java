...
public class PinViewSettings implements Parcelable{
    ...
    public static final int DEFAULT_CUSTOM_PIN_BOX = R.drawable.sample_background;
    ...
    public static final Creator<PinViewSettings> CREATOR = new Parcelable.Creator<PinViewSettings>() {
